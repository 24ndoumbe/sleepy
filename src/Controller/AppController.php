...
class AppController extends Controller
{
    ...
    public function initialize(): void
    {
      ...
      // Récupérer les résumés hebdomadaires (s'il y en a)
       // $weeklysummaries = $this->WeeklySummaries->find('all')->toArray();
        
        // Passer les résumés hebdomadaires à toutes les vues
    ...
    public function beforeFilter(\Cake\Event\EventInterface $event)
    {
        ...
        $this->Authentication->addUnauthenticatedActions(['index', 'view', 'login', 'add','weeklysummaries']);
